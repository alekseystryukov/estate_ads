...
class RegistrationView(BaseRegistrationView):
    ...
    * The creation of the templates
    ...
    def get_success_url(self, request, user):
        ...
        """
        return reverse('registration_complete', args=(user.id,))
    ...
    def activate(self, request, activation_key):
        ...
        if activated_user:
            signals.user_activated.send(sender=self.__class__,
                                        user=activated_user,
                                        request=request)
            messages.success(request, _('Your account was successfully activated.'))

        return activated_user

    def get_success_url(self, request, user):
        return reverse('profile', args=tuple())
    ...
    def get(self, request, *args, **kwargs):
        ...
        if user_id:
            try:
                ...
                c['mail_inbox'] = get_mailbox_by_email(user.email)
